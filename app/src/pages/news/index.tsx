...
function News() {
    ...
    const renderArticles = () => {
        ...
        for (let article of articles){
            console.log(article)
            result.push(<Article key={article.id} title={article.title} author={article.author} imgUrl={require('../../assets/images/backgrounds/' + article.slug + '.jpg')} slug={article.slug}/>)
        }
